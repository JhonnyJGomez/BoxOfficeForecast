...
@Controller
public class BaseConsultaParametroController {

    private static final Logger logger = LogManager.getLogger(BaseConsultaParametroController.class);

    @Autowired
    private ObjectMapper objMapper;

    public void evaluateValidation(BindingResult validation, HttpServletRequest request, ConsultarParametroReq obj)
    ...
    public void logBeforeHttpCall(HttpServletRequest request, ConsultarParametroReq obj) {
