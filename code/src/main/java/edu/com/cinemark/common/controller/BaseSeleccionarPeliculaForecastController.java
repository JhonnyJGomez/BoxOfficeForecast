...
@Controller
public class BaseSeleccionarPeliculaForecastController {

    private static final Logger logger = LogManager.getLogger(BaseSeleccionarPeliculaForecastController.class);

    @Autowired
    private ObjectMapper objMapper;

    public void evaluateValidation(BindingResult validation, HttpServletRequest request, SeleccionaPeliculaForecastReq obj)
    ...
    public void logBeforeHttpCall(HttpServletRequest request, SeleccionaPeliculaForecastReq obj) {
