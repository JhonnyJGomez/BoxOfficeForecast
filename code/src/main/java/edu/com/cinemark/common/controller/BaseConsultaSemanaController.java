...
@Controller
public class BaseConsultaSemanaController {

    private static final Logger logger = LogManager.getLogger(BaseConsultaSemanaController.class);

    @Autowired
    private ObjectMapper objMapper;

    public void evaluateValidation(BindingResult validation, HttpServletRequest request, ConsultarSemanasReq obj)
    ...
    public void logBeforeHttpCall(HttpServletRequest request, ConsultarSemanasReq obj) {
