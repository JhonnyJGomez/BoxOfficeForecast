...
@Controller
public class BaseConsultaPeliculasForecastSemanaController {

    private static final Logger logger = LogManager.getLogger(BaseConsultaPeliculasForecastSemanaController.class);

    @Autowired
    private ObjectMapper objMapper;

    public void evaluateValidation(BindingResult validation, HttpServletRequest request, ConsultarNumSemanaReq obj)
    ...
    public void logBeforeHttpCall(HttpServletRequest request, ConsultarNumSemanaReq obj) {
