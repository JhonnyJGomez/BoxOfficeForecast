...
@Controller
public class BaseConsultaCiudadController {

    private static final Logger logger = LogManager.getLogger(BaseConsultaCiudadController.class);

    @Autowired
    private ObjectMapper objMapper;

    public void evaluateValidation(BindingResult validation, HttpServletRequest request, ConsultarCiudadReq obj)
    ...
    public void logBeforeHttpCall(HttpServletRequest request, ConsultarCiudadReq obj) {
