...
import edu.com.cinemark.common.controller.BaseConsultaPeliculasForecastSemanaController;
...
import edu.com.cinemark.service.IConsultaPeliculasForecastSemana;
...
public class ConsultarPeliculasForecastSemanaRest extends BaseConsultaPeliculasForecastSemanaController{
	
	
	@Autowired
	private IConsultaPeliculasForecastSemana consultaPeliculasForecastSemana;
    ...
    @PostMapping("/consulta-peliculas-forecast-semana")
	public ResponseEntity<ConsultarPeliculasPorSemanaResp> getPeliculasPorSemana(@Valid @RequestBody ConsultarNumSemanaReq request, BindingResult bindingResult,
		...
		List<Peliculas> listPeliculas = consultaPeliculasForecastSemana.listarPeliculas(request);
		...
		System.out.println("hola Jhonny 2");
